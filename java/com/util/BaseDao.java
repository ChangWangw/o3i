...
public class BaseDao {
    ...
    //需要生成mapper文件的sql语句
    private static String sql = "SELECT * FROM produce_job pj \n" +
            "LEFT JOIN base_device bd ON pj.devid=bd.devid\n" +
            "LEFT JOIN produce_report pt ON pj.reportid=pt.reportid";
    //主表
    private static String mainTable = "produce_job";
    ...
    public static void main(String[] args) throws IOException {
        //文件输出位置
        File dir = new File("d:\\codeout\\generateMapper.xml");
        //字节输出流
...
//                    插入association配置
    ...
    public   static  Connection getConn(){
        ...
        String url = "jdbc:mysql://localhost:3306/diary?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=UTC&zeroDateTimeBehavior=convertToNull";
